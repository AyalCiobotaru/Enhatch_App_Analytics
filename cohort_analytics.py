...
def cohort_date(month, day, year, query_size):
...
def cohort_pull(month, day, year, account, query_size):
    if account is None:
        client.extraction('Page',
                          timeframe=cohort_date(month, day, year, query_size),
                          timezone=5,
                          email=input("\nWhat email would you like to send the cohort raw data to?"))
    else:
        client.extraction('Page',
                          timeframe=cohort_date(month, day, year, query_size),
                          timezone=5,
